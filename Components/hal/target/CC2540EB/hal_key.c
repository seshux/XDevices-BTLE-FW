...
/*#define HAL_KEY_SW_1_IENBIT   BV(6)*/ /* Mask bit for all of Port_0 */
...
/*#define HAL_KEY_SW_1_EDGEBIT  BV(5)*/
 ...
 * @return
 **************************************************************************************************/
#if !defined (XDEVICES_BEACON_DISPENSER) /*Supress this ISR for beacon dispenser*/
